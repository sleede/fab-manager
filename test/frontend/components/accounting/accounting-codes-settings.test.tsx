...
describe('AccountingCodesSettings', () => {
  ...
  test('render AccountingCodesSettings', async () => {
    ...
    expect(screen.getAllByLabelText(/app.admin.accounting_codes_settings.journal_code/)).toHaveLength(8);
    expect(screen.getAllByLabelText(/app.admin.accounting_codes_settings.code/)).toHaveLength(15);
    expect(screen.getAllByLabelText(/app.admin.accounting_codes_settings.label/)).toHaveLength(15);
