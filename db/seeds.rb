...
unless Setting.find_by(name: 'event_reduced_amount_alert').try(:value)
  setting = Setting.find_or_initialize_by(name: 'event_reduced_amount_alert')
  setting.value = "* Tarif réduit si vous avez moins de 25 ans, que vous êtes étudiant ou demandeur d'emploi."
  setting.save
end
